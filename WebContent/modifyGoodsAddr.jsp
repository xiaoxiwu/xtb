...
<body>
	...
	<form action="rest/goods/modifyGoodsAddr.do" method="post">
		<input type="text" name="apiKey" value="apiKey"> 
		<input type="text" name="MyId" value="MyId">
		<input type="text" name="goodsId" value="goodsId">
		<input type="text" name="goodsProvinceId" value="goodsProvinceId">
		<input type="text" name="goodsCityId" value="goodsCityId">
