...
<html>
<head>
<title>modifyGoodsPostageType</title>
...
<body>
	...
	<form action="rest/goods/modifyGoodsPostageType.do" method="post">
		<input type="text" name="apiKey" value="apiKey"> 
		<input type="text" name="MyId" value="MyId">
		<input type="text" name="goodsId" value="goodsId">
		<input type="text" name="goodsPostageType" value="goodsPostageType">
