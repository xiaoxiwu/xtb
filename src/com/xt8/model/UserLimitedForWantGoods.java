...
public class UserLimitedForWantGoods implements Serializable {
	...
	public UserLimitedForWantGoods(){
		
	}
	
	public UserLimitedForWantGoods(User userHost,User userLimited){
